...
- B4: Vào thư mục dự án, checkout sang branch "day-xx" (xx = 01,02,03,... tương ứng với buổi học ngày hôm đó). Mỗi ngày và với mỗi bài tập, các thầy cô sẽ cập nhật code mẫu ở trong thư mục `demo`.
