...
const data = [
  ...
  console.log(dataNonLodash);
   9  Day11/TuanHQ/Day12/src/views/home.pug 
  Viewed
  @@ -0,0 +1,9 @@
  doctype html
  html(lang="en")
    ...
    body
      h1 Home
      a(href="./lodash") Thực hành Expres và Lodash 
   16  Day11/TuanHQ/Day12/src/views/lodash.pug 
  Viewed
  @@ -0,0 +1,16 @@
  doctype html
  html(lang="en")
    ...
    body
      h1 Thực hành tìm hiểu Express và Lodash
      p Hà Quốc Tuấn  _.join -> _.reverse 
  
      a(href="/") Back to home nè
  
      script(type="module")
        include ../js/lodash.js
